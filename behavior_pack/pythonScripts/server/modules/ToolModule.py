...
class ToolModule(BaseServerModule):
    ...
    def example(self, system):
        ...
        # 范围耕地，数值作为转换的范围
        system.addData(
            StaticConfig.Data.TOOL_AREA_FARM, {"minecraft:diamond_hoe": 3}, version=0
        )
        # 快速挖掘，作为key的物品可以快速挖掘value的物品，*代表所有物品
        system.addData(
            StaticConfig.Data.TOOL_FAST,
            {
        ...
        # 爆炸挖掘，数值作为破坏的范围
        system.addData(
            StaticConfig.Data.TOOL_EXPLODE,
            {
