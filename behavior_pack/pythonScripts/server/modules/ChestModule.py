...
class ChestModule(BaseServerModule):
    ...
    def example(self, system):
        system.addData(StaticConfig.Data.CHEST_LOOT, {
            # key只用于合并，与其他配置不同即可
            config.ModName + ":some_drop": {
                # 迭代次数
                "rolls": {
                    # 最少迭代次数
                    "min": 1,
                ...
                "entries": [
                    {
                        ...
                        "items": [
                            {"itemName": "minecraft:bed", "auxValue": 0, "count": 1},
                            {"itemName": "minecraft:redstone", "auxValue": 0, "count": 1},
                        ]
                    }
                ],
            },
            # 这种方式展示了如何配置0.1%掉落概率的方案
            config.ModName + ":another_drop": {
                # 迭代次数
                "rolls": 1,
                "entries": [
                    {
                        "weight": 1,
                        "items": {"itemName": "minecraft:dirt", "auxValue": 0, "count": 1},
                    },
                    {
                        "weight": 999,
                        "item": None
